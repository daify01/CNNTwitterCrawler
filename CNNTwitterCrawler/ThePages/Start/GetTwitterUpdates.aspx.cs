...
{
    public partial class GetTwitterUpdates : System.Web.UI.Page
    {
        ...
        protected void searchsubmit_OnServerClick(object sender, EventArgs e)
        {
            ...
            //    {
            //        Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "message", "<script type='text/javascript'>alertify.alert('Message', '" + "Email Sent Successfully" + "', function(){location = '/ThePages/Start/GetTwitterUpdates.aspx';});</script>", false);
            //    }
            //}
            //catch (Exception ex)
            //{
